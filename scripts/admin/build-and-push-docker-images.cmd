...
SET DOCKER_REGISTRY=rodneywimberly/dockerrepositories/
...
docker build -t %DOCKER_HUB%%DOCKER_REGISTRY%consul-bootstrapper%DOCKER_TAG% ../../bootstrapper/.

echo " --> Building volume image for nfstest stack"
docker build -t %DOCKER_HUB%%DOCKER_REGISTRY%volume%DOCKER_TAG% ../../nfs/.
...
docker push %DOCKER_HUB%%DOCKER_REGISTRY%consul-bootstrapper%DOCKER_TAG%

echo " --> Pushing volume image for nfstest stack"
docker push %DOCKER_HUB%%DOCKER_REGISTRY%volume%DOCKER_TAG%
