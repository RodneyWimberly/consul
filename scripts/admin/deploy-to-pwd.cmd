...
start "Worker1 Update" /B putty.exe -m d:\consul\soakes\consul\scripts\admin\pwd-remote-cmd.sh ip172-18-0-48-c05v3ms34gag008pek0g@direct.labs.play-with-docker.com

echo " --> Executing update-stack.sh on Manager1"
start "Manager1 Update" /B putty.exe -m  d:\consul\soakes\consul\scripts\admin\pwd-remote-cmd.sh ip172-18-0-42-c05v3ms34gag008pek0g@direct.labs.play-with-docker.com
